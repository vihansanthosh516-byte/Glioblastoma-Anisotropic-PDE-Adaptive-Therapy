...
>>>>>>> 1be6df8e9737fb3a9f7ee274b3822d40fcc8b97c
cd "C:\Users\vihan\20206 science fair"
code README.md
# Ctrl+A → Delete → Paste → Ctrl+S

git add README.md
git commit -m "Rewrite README: Track A verified (100% real data, n=518 TCGA-GBM), Tracks B/C complete, remove merge conflict markers"
git push
git log --oneline -3