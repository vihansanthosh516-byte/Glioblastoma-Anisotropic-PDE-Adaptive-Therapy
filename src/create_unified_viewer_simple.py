#!/usr/bin/env python3
"""
Unified Patient 4D Viewer - Simple Direct HTML Generation
==========================================================
Generates a single HTML file with dropdown to switch between all 190 patient 4D simulations.
Uses direct file writing to avoid f-string template issues.
"""
...
def write_html(patients):
    """Write the complete HTML file directly."""
...
<body>
    <div class="container">
        ...
        <p class="subtitle">190 Patients | Interactive 4D Tumor Evolution | Clinical Treatment Timelines</p>
        
        <div class="patient-selector">
            <div class="selector-row">
                <div class="dropdown-wrapper">
                    <label for="patientDropdown" style="display:block; margin-bottom:5px; font-weight:600;">Select Patient:</label>
        ...
        <div class="charts-row">
            <div class="chart-container">
                <div class="chart-title">Tumor Volume Evolution</div>
                <div id="volumePlot" style="height: 400px;"></div>
            </div>
            <div class="chart-container">
                <div class="chart-title">Treatment Schedule</div>
                <div id="treatmentPlot" style="height: 400px;"></div>
            </div>
        </div>
        
        <div class="timeline-container chart-container">
            <div class="chart-title">Clinical Treatment Timeline</div>
    ...
    <script>
        ...
        function renderTreatmentPlot(data) {{
            ...
            const traces = [
                ...
                {{
                    x: x,
                    y: data.radiation_dose.map(d => d * 5),
                    mode: 'lines',
                    name: 'Radiation Dose (x5)',
